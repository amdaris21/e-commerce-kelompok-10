        ...
        <div class="min-h-screen bg-gray-100 flex">
            ...
            <div class="flex-1 flex flex-col">
                ...
                <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                    ...
                    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden bg-white border-b border-gray-100 absolute w-full z-50">
                        <div class="pt-2 pb-3 space-y-1">
                            <x-responsive-nav-link :href="route('seller.dashboard')" :active="request()->routeIs('seller.dashboard')">
                                {{ __('Dashboard') }}
                            </x-responsive-nav-link>
                             <x-responsive-nav-link :href="route('seller.store.manage')" :active="request()->routeIs('seller.store.*')">
                                {{ __('Profil Toko') }}
                            </x-responsive-nav-link>
                            ...
                            <x-responsive-nav-link :href="route('seller.balance.index')" :active="request()->routeIs('seller.balance.*')">
                                {{ __('Saldo Toko') }}
                            </x-responsive-nav-link>
                            <x-responsive-nav-link :href="route('seller.withdraw.index')" :active="request()->routeIs('seller.withdraw.*')">
                                {{ __('Penarikan Dana') }}
                            </x-responsive-nav-link>
                        </div>
