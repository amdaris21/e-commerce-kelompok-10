    ...
    <div class="container header-bar">
        <a class="brand" href="{{ route('customer.home') }}">
            ...
            <div>
                ...
                <div class="brand-tag">ring • necklace • sunglasses • bags</div>
            </div>
        </a>

        <div class="search">
            <div class="search-icon">⌕</div>
            <input type="text" placeholder="Cari aksesoris y2k..." />
        </div>
...
<main>
    ...
    <section class="container hero">
        <div class="hero-card">
            <div>
                <div class="hero-pill">Clean cyber • grayscale • y2k accessories</div>
                <h1 class="hero-title">Y2K <span>ACCESSORIES DROP</span></h1>
                <p class="hero-desc">
                    Fokus penjualan aksesoris: ring, necklace, belt, sunglasses, bags & charms.
                </p>
