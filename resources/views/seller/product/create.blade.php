                ...
                <form method="POST" action="{{ route('seller.products.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-3 gap-6">
                        <div class="mb-4">
                            ...
                            <x-text-input id="price" class="block mt-1 w-full" type="number" name="price"
                                :value="old('price')" required min="100" />
                    ...
                    <div class="mb-4">
                        ...
                        <select id="condition" name="condition"
                            ...
                            <option value="used" {{ old('condition') == 'used' ? 'selected' : '' }}>Bekas (Used)
                            </option>
                        </select>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="about"
                            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full"
                            name="about" rows="6" required>{{ old('about') }}</textarea>
                        <x-input-error :messages="$errors->get('about')" class="mt-2" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="images" :value="__('Gambar Produk (Min. 1, Maks. 5 File)')" />
                        <input id="images"
                        ...
                        <p class="mt-1 text-xs text-gray-500">Maks. 5 gambar, @2MB per gambar.</p>
